...
class NetworkingV1alpha1Api:
    ...
    def create_cluster_cidr(
        ...
        _param = self._create_cluster_cidr_serialize(
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    def create_cluster_cidr_with_http_info(
        self,
        body: V1alpha1ClusterCIDR,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alpha1ClusterCIDR]:
        """create_cluster_cidr
    ...
    @validate_call
    def create_cluster_cidr_without_preload_content(
        self,
        body: V1alpha1ClusterCIDR,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
    ...
    def _create_cluster_cidr_serialize(
        self,
        body,
        pretty,
        dry_run,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/apis/networking.k8s.io/v1alpha1/clustercidrs',
    ...
    @validate_call
    def delete_cluster_cidr(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
        ...
        _param = self._delete_cluster_cidr_serialize(
            name=name,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    def delete_cluster_cidr_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
    ...
    @validate_call
    def delete_cluster_cidr_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
    ...
    def _delete_cluster_cidr_serialize(
        self,
        name,
        pretty,
        dry_run,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_collection_cluster_cidr(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        ...
        _param = self._delete_collection_cluster_cidr_serialize(
            pretty=pretty,
    ...
    @validate_call
    def delete_collection_cluster_cidr_with_http_info(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
    ...
    @validate_call
    def delete_collection_cluster_cidr_without_preload_content(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        dry_run: Annotated[Optional[StrictStr], Field(description="When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed")] = None,
    ...
    def _delete_collection_cluster_cidr_serialize(
        self,
        pretty,
        var_continue,
        dry_run,
    ...
    def list_cluster_cidr(
        ...
        _param = self._list_cluster_cidr_serialize(
            pretty=pretty,
    ...
    @validate_call
    def list_cluster_cidr_with_http_info(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1alpha1ClusterCIDRList]:
        """list_cluster_cidr
    ...
    @validate_call
    def list_cluster_cidr_without_preload_content(
        self,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        allow_watch_bookmarks: Annotated[Optional[StrictBool], Field(description="allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")] = None,
        var_continue: Annotated[Optional[StrictStr], Field(description="The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.")] = None,
    ...
    def _list_cluster_cidr_serialize(
        self,
        pretty,
    ...
    def patch_cluster_cidr(
        ...
        _param = self._patch_cluster_cidr_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    def patch_cluster_cidr_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        body: Dict[str, Any],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
    ...
    @validate_call
    def patch_cluster_cidr_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        body: Dict[str, Any],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
    ...
    def _patch_cluster_cidr_serialize(
        self,
        name,
        body,
        pretty,
    ...
    def read_cluster_cidr(
        ...
        _param = self._read_cluster_cidr_serialize(
            name=name,
            pretty=pretty,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def read_cluster_cidr_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def read_cluster_cidr_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
        _request_timeout: Union[
    ...
    def _read_cluster_cidr_serialize(
        self,
        name,
        pretty,
        _request_auth,
    ...
    def replace_cluster_cidr(
        ...
        _param = self._replace_cluster_cidr_serialize(
            name=name,
            body=body,
            pretty=pretty,
            dry_run=dry_run,
    ...
    @validate_call
    def replace_cluster_cidr_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        body: V1alpha1ClusterCIDR,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
    ...
    @validate_call
    def replace_cluster_cidr_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="name of the ClusterCIDR")],
        body: V1alpha1ClusterCIDR,
        pretty: Annotated[Optional[StrictStr], Field(description="If 'true', then the output is pretty printed.")] = None,
    ...
    def _replace_cluster_cidr_serialize(
        self,
        name,
        body,
        pretty,
