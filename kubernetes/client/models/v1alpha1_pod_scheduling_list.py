...
class V1alpha1PodSchedulingList(BaseModel):
    """
    ...
    items: List[V1alpha1PodScheduling] = Field(description="Items is the list of PodScheduling objects.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha1PodScheduling.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
