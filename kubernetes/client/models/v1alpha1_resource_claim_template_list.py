...
class V1alpha1ResourceClaimTemplateList(BaseModel):
    """
    ...
    items: List[V1alpha1ResourceClaimTemplate] = Field(description="Items is the list of resource claim templates.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha1ResourceClaimTemplate.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
