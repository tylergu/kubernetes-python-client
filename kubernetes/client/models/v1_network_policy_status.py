...
class V1NetworkPolicyStatus(BaseModel):
    """
    NetworkPolicyStatus describe the current state of the NetworkPolicy.
    """ # noqa: E501
    conditions: Optional[List[V1Condition]] = Field(default=None, description="Conditions holds an array of metav1.Condition that describe the state of the NetworkPolicy. Current service state")
