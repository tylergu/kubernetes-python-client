...
class V1beta1CSIStorageCapacityList(BaseModel):
    """
    ...
    items: List[V1beta1CSIStorageCapacity] = Field(description="Items is the list of CSIStorageCapacity objects.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta1CSIStorageCapacity.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
