...
class V1alpha1ResourceClaimList(BaseModel):
    """
    ...
    items: List[V1alpha1ResourceClaim] = Field(description="Items is the list of resource claims.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha1ResourceClaim.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
