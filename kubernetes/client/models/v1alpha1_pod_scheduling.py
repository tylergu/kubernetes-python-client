...
class V1alpha1PodScheduling(BaseModel):
    """
    ...
    status: Optional[V1alpha1PodSchedulingStatus] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1PodSchedulingSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": V1alpha1PodSchedulingStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
