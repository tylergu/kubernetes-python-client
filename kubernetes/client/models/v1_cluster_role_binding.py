...
class V1ClusterRoleBinding(BaseModel):
    ...
    subjects: Optional[List[V1Subject]] = Field(default=None, description="Subjects holds references to the objects the role applies to.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "subjects": [V1Subject.from_dict(_item) for _item in obj.get("subjects")] if obj.get("subjects") is not None else None
        })
        return _obj
