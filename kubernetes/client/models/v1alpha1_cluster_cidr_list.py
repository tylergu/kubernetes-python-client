...
class V1alpha1ClusterCIDRList(BaseModel):
    """
    ...
    items: List[V1alpha1ClusterCIDR] = Field(description="Items is the list of ClusterCIDRs.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1alpha1ClusterCIDR.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
