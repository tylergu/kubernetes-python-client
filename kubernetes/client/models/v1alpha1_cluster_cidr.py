...
class V1alpha1ClusterCIDR(BaseModel):
    """
    ...
    spec: Optional[V1alpha1ClusterCIDRSpec] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1ClusterCIDRSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
