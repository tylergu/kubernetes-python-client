...
class V1alpha1ResourceClaim(BaseModel):
    """
    ...
    status: Optional[V1alpha1ResourceClaimStatus] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1alpha1ResourceClaimSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": V1alpha1ResourceClaimStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
