...
class V1VolumeAttachmentStatus(BaseModel):
    ...
    attachment_metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Upon successful attach, this field is populated with any information returned by the attach operation that must be passed into subsequent WaitForAttach or Mount calls. This field must only be set by the entity completing the attach operation, i.e. the external-attacher.", alias="attachmentMetadata")
