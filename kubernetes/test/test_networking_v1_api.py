...
class TestNetworkingV1Api(unittest.TestCase):
    ...
    def test_patch_namespaced_network_policy_status(self) -> None:
    ...
    def test_read_namespaced_network_policy_status(self) -> None:
    ...
    def test_replace_namespaced_network_policy_status(self) -> None:
