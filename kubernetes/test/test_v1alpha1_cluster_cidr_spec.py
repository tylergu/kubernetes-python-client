...
class TestV1alpha1ClusterCIDRSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1alpha1ClusterCIDRSpec:
        """Test V1alpha1ClusterCIDRSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alpha1ClusterCIDRSpec`
        """
        model = V1alpha1ClusterCIDRSpec()
        if include_optional:
