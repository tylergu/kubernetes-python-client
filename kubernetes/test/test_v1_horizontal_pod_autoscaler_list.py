    ...
    def make_instance(self, include_optional) -> V1HorizontalPodAutoscalerList:
        ...
        if include_optional:
            return V1HorizontalPodAutoscalerList(
                api_version = '',
                items = [
                    kubernetes.client.models.v1/horizontal_pod_autoscaler.v1.HorizontalPodAutoscaler(
                        api_version = '', 
                        kind = '', 
                        metadata = kubernetes.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '', 
                            uid = '', ), 
                        spec = kubernetes.client.models.v1/horizontal_pod_autoscaler_spec.v1.HorizontalPodAutoscalerSpec(
                            max_replicas = 56, 
                            min_replicas = 56, 
                        ...
                        status = kubernetes.client.models.v1/horizontal_pod_autoscaler_status.v1.HorizontalPodAutoscalerStatus(
