...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NetworkingV1Api->patch_namespaced_network_policy_status:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NetworkingV1Api->read_namespaced_network_policy_status:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NetworkingV1Api->replace_namespaced_network_policy_status:\n")
        pprint(api_response)
    except Exception as e:
