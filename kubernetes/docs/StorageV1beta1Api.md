...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    body = kubernetes.client.V1beta1CSIStorageCapacity() # V1beta1CSIStorageCapacity | 
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->create_namespaced_csi_storage_capacity:\n")
        pprint(api_response)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->delete_collection_namespaced_csi_storage_capacity:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->delete_namespaced_csi_storage_capacity:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->list_csi_storage_capacity_for_all_namespaces:\n")
        pprint(api_response)
    except Exception as e:
...
> V1beta1CSIStorageCapacityList list_namespaced_csi_storage_capacity(namespace, pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, timeout_seconds=timeout_seconds, watch=watch)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->list_namespaced_csi_storage_capacity:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->patch_namespaced_csi_storage_capacity:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->read_namespaced_csi_storage_capacity:\n")
        pprint(api_response)
    except Exception as e:
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StorageV1beta1Api->replace_namespaced_csi_storage_capacity:\n")
        pprint(api_response)
    except Exception as e:
