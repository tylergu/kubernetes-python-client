...
json = "{}"
# create an instance of V1beta1CSIStorageCapacity from a JSON string
v1beta1_csi_storage_capacity_instance = V1beta1CSIStorageCapacity.from_json(json)
# print the JSON string representation of the object
print V1beta1CSIStorageCapacity.to_json()

# convert the object into a dict
v1beta1_csi_storage_capacity_dict = v1beta1_csi_storage_capacity_instance.to_dict()
# create an instance of V1beta1CSIStorageCapacity from a dict
v1beta1_csi_storage_capacity_form_dict = v1beta1_csi_storage_capacity.from_dict(v1beta1_csi_storage_capacity_dict)
```
